...
@section('content')
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" ng-controller="PostEditCtrl">
  ...
  <div class="table-responsive">
    <!-- <form> -->
      ...
      <button ng-click="update(input);" class="btn btn-primary">Lưu</button>
